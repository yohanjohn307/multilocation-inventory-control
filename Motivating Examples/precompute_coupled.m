function [SASPM,SACM] = precompute_coupled(T1,T2,U1,U2,B,w_vals,w_probs,alpha,beta,l,h,K,K_h,order_flag)
    ...
    for i = 1:numel(U1)
        ...
        SACM(:,i) = reshape(order_cost(U,l,h,K,K_h,order_flag,dim_flag) ...
