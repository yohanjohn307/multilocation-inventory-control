...
[cost_coupled,cost_decoupled,cost_online] = monte_carlo_policy_evaluation_v2(X1,X2,U1,U2,...
    U_coupled,U_decoupled,N,B,N_sims,w_vals,w_probs,alpha,beta,l,h,K,K_h,x_switch,order_flag);

%% Post-processing
% visualize(x_vec,U1,U2,U_coupled,U_decoupled,J_coupled,J_decoupled,...
%     cost_coupled,cost_decoupled,cost_online,order_flag)
visualize_v2(x_vec,U1,U2,U_coupled,U_decoupled,J_coupled,J_decoupled,...
    cost_coupled,cost_decoupled,cost_online,order_flag)
% save(['data_' order_flag '.mat'],'X1','X2','U1','U2','cost_coupled','cost_decoupled','cost_online',...
%   'U_coupled','U_decoupled','J_coupled','J_decoupled','N','B','w_vals',...
%   'w_probs','alpha','beta','l','h','K','K_h','order_flag');